...
<div class="form-v9">
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-9 text-center mt-5">
          <h1 class="heading" data-aos="fade-up">User Signup</h1>
  ...
  <div class="page-content" style="background: white;">
    <div class="form-v9-content" style="background: #005555">
      <form class="form-detail" action="<?php echo URLROOT ?>/Estate/register/buyer"
        method="POST" enctype="multipart/form-data">
        <h2>User Sign Up</h2>
        <p class="required" style="margin-left: 45%"><strong class="text-danger">*</strong>Required fields</p>
        <p class="required" style="margin-left: 25%"><strong class="text-danger">*</strong>Password must be at least 8
          characters and
          must contain a letter</p>
        <div class="form-row-total">
          <div class="form-row">
            <label for="">Your Full Name <strong class="text-danger">*</strong></label>
        ...
        <div class="form-row-total">
          ...
          <div class="form-row">
            ...
            <input type="file" name="upload_cv" id="upload" class="input-text" />
          </div>
        </div>
        <div class="form-row-total">
          <div class="form-row">
        ...
        <div class="form-row-total">
          ...
          <div class="form-row">
            ...
            <input type="password" name="confirmP" id="comfirm-password" class="input-text"
        ...
        <div class="form-row-last">
          <label for="button">Already have an account? click here to
            <a href="<?php echo URLROOT ?>/Estate/login" style="color: #f25d5d; text-decoration: none;">
              Login</a></label>
        </div>
        <div class="form-row-last">
          <label for="button">Do you want to be an agent? click here to
            <a href="<?php echo URLROOT ?>/Estate/register/agent" style="color: #f25d5d; text-decoration: none;">
              Register</a></label>
        </div>
      </form>
    </div>
